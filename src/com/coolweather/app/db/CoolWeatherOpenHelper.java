...
public class CoolWeatherOpenHelper extends SQLiteOpenHelper {
	 ...
	 * County表建表语句
	 */
	public static final String CREATE_COUNTY = "create table County(id integer primary key autoincrement,county_name text,county_code text,province_id integer)";
